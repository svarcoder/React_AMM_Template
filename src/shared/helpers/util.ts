...
export const bustRstPairArray = ["BUST","RST"]
export const wbnbRstPairArray = ["WBNB", "RST"]

export const validateAndTrim = (val: React.ChangeEvent<HTMLInputElement>, afterDecimal: any) => {
