...
export const lightTheme: Theme = {
  ...
  tableHeader: "#F7F9FA",
  rowHighlight:
    "linear-gradient(0deg, rgba(51, 187, 64, 0.3216), rgba(51, 187, 64, 0.3216)), #FFFFFF",
