...
export const inputStyleDynamicSize = css<any>`
  ...
  :-webkit-autofill {
    -webkit-border: ${(props) =>
      props.hasErrors && `2px solid ${colors.errorRed}`} !important;
    -webkit-text-fill-color: ${(props) =>
      props.hasErrors ? colors.errorRed : props.theme.white};
    -webkit-box-shadow: 0 0 0px 1000px ${(props) => props.theme.input.basic}
      inset !important;
    ...
    &:focus {
      ...
      border: ${(props) =>
        props.hasErrors
          ...
          : `1px solid ${colors.green}`} !important;
    }
  }
  svg {
    path {
...
export const UpTick = styled.i<any>`
  transform: ${(props) =>
    props.shouldRotate ? "rotate(45deg)" : "rotate(225deg)"};
  border: solid black;
...
export const ListLabel = styled<any>(DetailsLabel)`
  ...
  font-family: "NunitoSansBold";
  color: ${(props) =>
    props.error === "true" ? colors.errorRed : props.theme.white};
  margin: 4px 0 4px 0;
`
